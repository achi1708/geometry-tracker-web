...
class InstagramBtn extends Component {
    constructor (props) {
        super(props);
    ...
    render () {
       ...
       return (
        <a onClick={this.callToAction} className="btn btn-instagram btn-user">
            <i className="fab fa-instagram fa-fw"></i> Obtener información actualizada
        </a>
       );
    }
}

export default withRouter(InstagramBtn);